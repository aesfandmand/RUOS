...
def _canonical_payload(page: PageSpec, dna: VisualDNA, components: ComponentPlan, patterns: PatternPlan, motion: MotionPlan, content: ContentPlan, html: str, css: str, runtime: str) -> dict[str, object]:
    ...
    return {
        ...
        "spec": asdict(page),
        "artifacts": {"index.html": _digest(html), "assets/styles.css": _digest(css), "assets/runtime.js": _digest(runtime), "assets/motion-manifest.json": _digest(motion_json)},
    }
...
def compile_page(page: PageSpec, context: BuildContext) -> BuildResult:
    ...
    payload = _canonical_payload(page, dna, components, patterns, motion, content, html, css, runtime)
    ...
    try:
        ...
        files = (_write(staging_root / "index.html", html), _write(assets_dir / "styles.css", css), _write(assets_dir / "runtime.js", runtime), _write(assets_dir / "motion-manifest.json", motion_json))
